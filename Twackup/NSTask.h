...
@property (nullable, copy) NSURL *executableURL API_AVAILABLE(macos(10.13), ios(11.0));
...
// actions
- (BOOL)launchAndReturnError:(out NSError **_Nullable)error API_AVAILABLE(macos(10.13), ios(11.0));
...
*/
@property (nullable, copy) void (^terminationHandler)(NSTask *) API_AVAILABLE(macos(10.7), ios(5.0));
...
+ (nullable NSTask *)launchedTaskWithExecutableURL:(NSURL *)url arguments:(NSArray<NSString *> *)arguments error:(out NSError ** _Nullable)error terminationHandler:(void (^_Nullable)(NSTask *))terminationHandler API_AVAILABLE(macos(10.13), ios(11.0));
...
@property (nullable, copy) NSString *launchPath API_DEPRECATED_WITH_REPLACEMENT("-executableURL", macos(10.3, 10.13), ios(2.0, 11.0));
@property (copy) NSString *currentDirectoryPath API_DEPRECATED_WITH_REPLACEMENT("-currentDirectoryUR", macos(10.3, 10.13), ios(2.0, 11.0)); // if not set, use current

- (void)launch API_DEPRECATED_WITH_REPLACEMENT("-launchAndReturnError:", macos(10.3, 10.13), ios(2.0, 11.0));

+ (NSTask *)launchedTaskWithLaunchPath:(NSString *)path arguments:(NSArray<NSString *> *)arguments API_DEPRECATED_WITH_REPLACEMENT("-launchedTaskWithExecutableURL:arguments:error:terminationHandler", macos(10.3, 10.13), ios(2.0, 11.0));
